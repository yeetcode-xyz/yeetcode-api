...
def _migrate_add_columns(conn):
    ...
    additions = [
        ...
        ("blitz_challenges", "challenger_last_seen",  "TEXT DEFAULT NULL"),
        ("blitz_challenges", "game_started_at",       "TEXT DEFAULT NULL"),
        ("blitz_challenges", "challenger_score",      "INTEGER DEFAULT 0"),
        ("blitz_challenges", "challenger_total",     "INTEGER DEFAULT 0"),
        ("blitz_challenges", "challenger_time_ms",   "INTEGER DEFAULT 0"),
        ("blitz_challenges", "opponent",             "TEXT DEFAULT NULL"),
        ("blitz_challenges", "status",               "TEXT DEFAULT 'pending'"),
        ("blitz_challenges", "opponent_score",       "INTEGER DEFAULT NULL"),
        ("blitz_challenges", "opponent_total",       "INTEGER DEFAULT NULL"),
        ("blitz_challenges", "opponent_time_ms",     "INTEGER DEFAULT NULL"),
        ("blitz_challenges", "winner",               "TEXT DEFAULT NULL"),
        ("blitz_challenges", "xp_awarded",           "INTEGER DEFAULT 0"),
